...
begin
  ...
  ArrOfFields[High(ArrOfFields)] :=
    TMyField.Create(MyCaption, MyName, MyWidth, MyFieldType,
    MyJoinTable, MyJoinField, MyJoinKey, MyOrder);
...
begin
  Result := 'Select ';
  for i := 0 to High(ArrOfFields) do
  begin
    if i > 0 then
      Result += ', ';
